<?php
include "connect.php";
$sql = mysqli_query($con, "SELECT * FROM user_login
                          INNER JOIN user_register_table ON user_login.login_id = user_register_table.login_id");?>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="DifrentlyAbled.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <ul class="nav nav-treeview">
    ...
    <li class="nav-item">
      ...
      <ul class="nav nav-treeview">
        ...
        <li class="nav-item">
          <a href="medcicinerequests" class="nav-link">
            <i class="far fa-circle nav-icon"></i>
            <p>Medicine</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="othersrequests" class="nav-link">
            <i class="far fa-circle nav-icon"></i>
            <p>Others</p>
          </a>
        </li>
