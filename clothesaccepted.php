<?php
include "connect.php";
$sql = mysqli_query($con,"SELECT * FROM request_table INNER JOIN user_register_table ON request_table.login_id = user_register_table.login_id WHERE req_status='Accepted' && type='clothes'"); 
if ($sql === false) {
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Clothes Requests Accepted</h3>
