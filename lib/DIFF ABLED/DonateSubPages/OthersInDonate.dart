...
class _OthersState extends State<Others> {
  ...
  Future<void> OthersRequest() async {
    var data = {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        title: Center(child: Text('Other Request')),
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            fit: BoxFit.cover,
                            image:AssetImage('assets/Images/2014_1_donation_base.jpg'))),
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.all(18.0),
                  child: Text('Describe your request',style: TextStyle(fontSize:23,fontWeight: FontWeight.w800),),
                ),

                Padding(
                  padding: const EdgeInsets.only(left: 25,right: 25,bottom: 18,top:10),
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      label:Text(
                          'Add type,name and quantity of items needed(in terms of required for number of persons). Add Size and type of the items needed(if ant)& Mention if any special requirements needed.. ',textAlign: TextAlign.start),
                ...
                Padding(
                  padding: const EdgeInsets.only(left: 18.0,right: 8,top: 18,bottom: 12),
