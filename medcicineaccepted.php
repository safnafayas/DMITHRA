<?php
include "connect.php";
$sql = mysqli_query($con,"SELECT * FROM request_table INNER JOIN user_register_table ON request_table.login_id = user_register_table.login_id WHERE req_status='Accepted' && type='medicine'"); 
if ($sql === false) {
...
<div class="wrapper">  <!-- Navbar -->
  ...
  <!-- /.navbar --><aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">DMITHRA</span>
    </a>
  ...
  <a href="#" class="nav-link active">
    ...
    <p>
      Requests
      <i class="right fas fa-exclamation-circle"></i>
    </p>
  </a>
  <ul class="nav nav-treeview">
    <li class="nav-item ">
      ...
      <ul class="nav nav-treeview">
        ...
        <li class="nav-item">
          <a href="medicicineaccepted.php" class="nav-link">
            <i class="far fa-circle nav-icon"></i>
            <p>Medicine</p>
          </a>
        </li>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Medicine Requests Accepted</h3>
  ...
  if($sql->num_rows>0){
    ...
    while($row=mysqli_fetch_array($sql)){
        ...
        $filename=($row['image']);
        $path="http://localhost/dmithra/prescribtionUpload/$filename";
        ?>
                    <tr>
