...
while($row=mysqli_fetch_array($sql)){
    ...
    $filename=($row['image']);
    $path="http://localhost/dmithra/postsupload/$filename";
    ?>
              
                  <div class="col-sm-2">
                    <a href="<?php echo $path; ?>" data-toggle="lightbox" data-title="sample 1 - white" data-gallery="gallery">
                      <img src="<?php echo $path; ?>" class="img-fluid mb-2"  />
