<?php
include "connect.php";
$sql = mysqli_query($con,"SELECT * FROM request_table INNER JOIN user_register_table ON request_table.login_id = user_register_table.login_id WHERE req_status='Accepted' && type='money'"); 
if ($sql === false) {
