...
class AccessoriesDonate extends StatefulWidget {
  const AccessoriesDonate({super.key});

  @override
  State<AccessoriesDonate> createState() => _AccessoriesDonateState();
}

class _AccessoriesDonateState extends State<AccessoriesDonate> {
  ...
  Future<void> accessoriesrequest() async {
    var data = {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        title: Center(child: Text('Request Accessories')),
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text('Accessories Description',style: TextStyle(fontSize:23,fontWeight: FontWeight.w800),),
                ),
